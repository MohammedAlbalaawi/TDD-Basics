...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::put('/projects/{project}', [ProjectsController::class, 'update'])->name('update.projects');
    Route::get('/projects/{project}/edit', [ProjectsController::class, 'edit'])->name('ViewEdit.projects');
